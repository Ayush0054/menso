    ...
    payload = {
        "session": {
            ...
            "instructions": (
                ...
                "Delegation policy:\n"
                "Backend tools:\n"
                "- Mac actions: request opening an app, focusing a known window, inserting exact dictated text "
                ...
                "- The request needs generated text, screen reading, or multi-step work: those are not supported.\n"
