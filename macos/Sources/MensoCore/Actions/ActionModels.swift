...
public enum ActionErrorCode: String, Codable, Hashable, Sendable {
    ...
    case driverIntegrityFailed = "driver_integrity_failed"
    case driverPermissionMissing = "driver_permission_missing"
    case driverToolRejected = "driver_tool_rejected"
    case driverProtocolFailure = "driver_protocol_failure"
